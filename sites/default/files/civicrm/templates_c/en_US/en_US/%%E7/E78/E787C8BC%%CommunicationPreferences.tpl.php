...
smarty_core_load_plugins(array('plugins' => array(array('function', 'help', 'CRM/Contact/Form/Edit/CommunicationPreferences.tpl', 46, false),array('modifier', 'crmReplace', 'CRM/Contact/Form/Edit/CommunicationPreferences.tpl', 52, false),array('block', 'ts', 'CRM/Contact/Form/Edit/CommunicationPreferences.tpl', 54, false),)), $this); ?>
...
<div id="commPrefs" class="ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom">
    ...
    <table class="form-layout-compressed" >
	    ...
	    <?php if ($this->_tpl_vars['form']['email_greeting_id'] || $this->_tpl_vars['form']['postal_greeting_id'] || $this->_tpl_vars['form']['addressee_id']): ?>
                <td>&nbsp;&nbsp;<?php echo smarty_function_help(array('id' => "id-greeting"), $this);?>
</td>
	    <?php endif; ?>
        </tr>
        <tr>
...
</span> <?php echo smarty_function_help(array('id' => "id-".($this->_tpl_vars['key'])), $this);?>
