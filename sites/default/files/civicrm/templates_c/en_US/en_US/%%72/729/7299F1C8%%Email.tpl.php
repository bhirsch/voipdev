...
smarty_core_load_plugins(array('plugins' => array(array('block', 'ts', 'CRM/Contact/Form/Edit/Email.tpl', 32, false),array('function', 'help', 'CRM/Contact/Form/Edit/Email.tpl', 36, false),array('modifier', 'crmReplace', 'CRM/Contact/Form/Edit/Email.tpl', 43, false),)), $this); ?>
...
">
    <td><?php echo ((is_array($_tmp=$this->_tpl_vars['form']['email'][$this->_tpl_vars['blockId']]['email']['html'])) ? $this->_run_mod_handler('crmReplace', true, $_tmp, 'class', 'twenty') : smarty_modifier_crmReplace($_tmp, 'class', 'twenty')); ?>
